...
export PATH_TEMPLATES_BASE_DOMAIN_INTERFACES_IEXAMPLEREPOSITORY="$TEMPLATES_PATH/base/Domain/Interfaces/IExempleRepository.cs"
...
export PATH_TEMPLATES_BASE_INFRA_DATA_CONTEXTS_APPLICATIONDBCONTEXT="$TEMPLATES_PATH/base/Infra.Data/Contexts/ApplicationDbContext.cs"
