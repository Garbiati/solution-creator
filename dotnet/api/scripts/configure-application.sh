...
validate_file "$PATH_TEMPLATES_BASE_APPLICATION_MAPPING_EXAMPLEMAPPINGPROFILE"
...
NEW_APPLICATION_MAPPING_EXAMPLEMAPPINGPROFILE="$PROJECT_NAME.Application/Mapping/ExampleMappingProfile.cs"
...
sed "s/{{PROJECT_NAME}}/$PROJECT_NAME/g" "$PATH_TEMPLATES_BASE_APPLICATION_MAPPING_EXAMPLEMAPPINGPROFILE" > "$NEW_APPLICATION_MAPPING_EXAMPLEMAPPINGPROFILE"
...
validate_file "$NEW_APPLICATION_MAPPING_EXAMPLEMAPPINGPROFILE"
