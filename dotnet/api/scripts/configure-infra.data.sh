...
validate_file "$PATH_TEMPLATES_BASE_INFRA_DATA_CONTEXTS_APPLICATIONDBCONTEXT"
...
NEW_INFRA_DATA_CONTEXTS_APPLICATIONDBCONTEXT="$PROJECT_NAME.Infra.Data/Contexts/ApplicationDbContext.cs"
...
sed "s/{{PROJECT_NAME}}/$PROJECT_NAME/g" "$PATH_TEMPLATES_BASE_INFRA_DATA_CONTEXTS_APPLICATIONDBCONTEXT" > "$NEW_INFRA_DATA_CONTEXTS_APPLICATIONDBCONTEXT"
...
validate_file "$NEW_INFRA_DATA_CONTEXTS_APPLICATIONDBCONTEXT"
