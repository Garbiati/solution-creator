...
sed "s/{{PROJECT_NAME}}/$PROJECT_NAME/g" "$PATH_TEMPLATES_BASE_VSCODE_LAUNCH" > "$NEW_VSCODE_LAUNCH"
sed "s/{{PROJECT_NAME}}/$PROJECT_NAME/g" "$PATH_TEMPLATES_BASE_VSCODE_TASKS" > "$NEW_VSCODE_TASKS"
